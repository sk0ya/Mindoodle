...
| `historySlice.ts` | 191行 | 182行 | -9行 | -5% |
| `nodeHash.ts` | 133行 | 89行 | -44行 | -33% |
| `mermaidCache.ts` | 99行 | 91行 | -8行 | -8% |
| `helpers.ts` | 89行 | 78行 | -11行 | -12% |
| `NodeClipboardService.ts` | 85行 | 71行 | -14行 | -16% |
| `checkboxOperations.ts` | 64行 | 51行 | -13行 | -20% |
| `nodeGeometry.ts` | 39行 | 27行 | -12行 | -31% |
| **合計** | **5,899行** | **4,465行** | **-1,434行** | **-24%** |
